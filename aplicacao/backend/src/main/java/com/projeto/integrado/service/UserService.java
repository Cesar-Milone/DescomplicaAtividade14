...
public class UserService {
	...
	public User findByProject(String description){
        return userRepository.findByProjectDescription(description).get();
    }

	public User findByResource(String resourceName){
        return userRepository.findByResourceName(resourceName).get();
    }
	
	public User findByTask(Boolean state){
        return userRepository.findByTaskState(state).get();
    }
